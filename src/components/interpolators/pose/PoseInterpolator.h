...
#include "IPoseInterpolator.h"

class PoseInterpolator : public IPoseInterpolator
{
public:
    PoseInterpolator(double interpolationThreshold) : interpolationThreshold(interpolationThreshold) {}
