...
std::vector<Pose> PoseInterpolator::interpolate(const Pose &start, const Pose &end)
{
...
Pose PoseInterpolator::getIntermediatePosition(const Pose &from, const Pose &to, double stepSize)
{
...
void PoseInterpolator::resolveDependencies(const ComponentConfig &config, ComponentManager *manager)
{
    IPoseInterpolator::resolveDependencies(config, manager);
